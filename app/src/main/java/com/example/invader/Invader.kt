...
fun Splitter(width: Dp = 20.dp, color: Color = Color.Black, onClick: () -> Unit = {}) {
  Column(modifier = Modifier.height(200.dp).clickable(onClick = onClick), verticalArrangement = Arrangement.Center) {
